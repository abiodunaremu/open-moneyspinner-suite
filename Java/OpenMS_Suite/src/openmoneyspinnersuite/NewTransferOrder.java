...
final class NewTransferOrder extends javax.swing.JInternalFrame {
    ...
    String creditOrderCode,debitOrderCode;
    Thread processThread=new Thread();
    Thread titleThread=new Thread();

    /** Creates new form NewCreditOrder */
    public NewTransferOrder() {
        initComponents();
        setTitle("::. New Transfer Order By User ("+OpenMSApp.EmployeeName+")");
        reset();
    ...
    private void initComponents() {
        ...
        jDebitAccountNameComboBox = new javax.swing.JComboBox();
        ...
        setMaximizable(true);
        setResizable(true);
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(openmoneyspinnersuite.OpenMS_Finance_App.class).getContext().getResourceMap(NewTransferOrder.class);
        ...
        jDebitAccountNameComboBox.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "-- Select --" }));
        jDebitAccountNameComboBox.setName("jDebitAccountNameComboBox"); // NOI18N
        jDebitAccountNameComboBox.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jDebitAccountNameComboBoxActionPerformed(evt);
            }
        });
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(jDebitAccountNameComboBox, javax.swing.GroupLayout.PREFERRED_SIZE, 185, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(36, 36, 36)
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(jDebitAccountNameComboBox, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    public void performMakeOrder(){
       ...
       int b=0;
        ...
        {
            JOptionPane.showMessageDialog(JOptionPane.getRootFrame(),"TOTAL AMOUNT RESULTS IN ERROR !","ERROR !",JOptionPane.ERROR_MESSAGE);
            reset();
            return;
        }
        ...
        if(jDebitAccountNameComboBox.getSelectedItem().equals("-- Select --"))
        {
            JOptionPane.showMessageDialog(JOptionPane.getRootFrame(),"PLEASE SELECT DEBIT ACCOUNT ","ERROR !",JOptionPane.ERROR_MESSAGE);
            return;
        }
        ...
        if(jDebitAccountNameComboBox.getSelectedItem().equals("-- Select --")==false||jCreditAccountNameComboBox.getSelectedItem().equals("-- Select --")==false)
        {
            String dActName=jDebitAccountNameComboBox.getSelectedItem().toString().trim();
        ...
        String debitAccountName=String.valueOf(jDebitAccountNameComboBox.getSelectedItem());
        ...
        {
            JOptionPane.showMessageDialog(JOptionPane.getRootFrame()," SELECTED DEBIT ACCOUNT IS FROZEN ! \n SEE YOUR ACCOUNT ADMINISTRATOR FOR DETAILS.","ERROR !",JOptionPane.ERROR_MESSAGE);
            return;
        }
        ...
        {
                JOptionPane.showMessageDialog(JOptionPane.getRootFrame()," INSUFFICIENT FUND IN THE SELECTED DEBIT ACCOUNT \n  FOR THIS TRANSACTION !","ERROR !",JOptionPane.ERROR_MESSAGE);
                return;
        }
        makeOrder();
        printReceipt();
    ...
    private void jDebitAccountNameComboBoxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jDebitAccountNameComboBoxActionPerformed
    ...
    }//GEN-LAST:event_jDebitAccountNameComboBoxActionPerformed
...
private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(processThread.isAlive())
        {
            ...
            this.setTitle("::. New Transfer Order By User ("+OpenMSApp.EmployeeName+")");
            enableControls();
        }
        else
            dispose();
    ...
    public void makeOrder()
    {
        ...
        String debitAccountName=String.valueOf(jDebitAccountNameComboBox.getSelectedItem()).trim();
        ...
        statement=Connect.createStatement(Connect.procInit+"  prnInsCreditOrderOnOrder"+Connect.procInitStart+"?,?,?,?,?,?,?,?,?,?,?,?,?"+Connect.procInitEnd);
         try{
                    ...
                    statement.setString(10,"Transfer Activity");
                    statement.setString(11,"TR");
                    statement.setString(12,refCode);
                    statement.setString(13,systems.converToRealMoneyFormat(jToBalanceTextField.getText().trim()));
            }
            catch(Exception e)
            {
                System.out.println("New Transfer Order 1.makeOrder() gave error ! "+e);
            }
        ...
        while(y<x)
        {
            if(!jTable1.getValueAt(y,3).equals("0"))
            {
             ...
             try{
                ...
                {
                        System.out.println("NewTransferOrder2.makeOrder() gave error ! "+e);
                }
            Connect.executeUpdateStatement(statement);
            }
            else
        ...
        statement=Connect.createStatement(Connect.procInit+"  prnInsDebitOrderOnOrder"+Connect.procInitStart+"?,?,?,?,?,?,?,?,?,?,?,?,?"+Connect.procInitEnd);
         try{
            ...
            {
                System.out.println("NewTransferOrder3.makeOrder() gave error ! "+e);
            }
        Connect.executeUpdateStatement(statement);
    ...
    public void printReceipt()
    {
        ...
        try
        {
            ...
            note.writeReceipt(creditOrderCode,"Transfer Activity",1);
    ...
    public void printVoucher()
    {
        ...
        {
            NoteWriter note=new NoteWriter();
            note.writeVoucher(debitOrderCode,"Transfer Activity",1);
    ...
    public void selectUserDefault()
    {
        if(jCheckBox4.isSelected()==false)
        {
            ...
            jDebitAccountNameComboBox.setSelectedItem("STOCK RETAIL");
    ...
    {
        try{
            this.setTitle("::. New Transfer Order - Processing Request");
            thread.sleep(500);
            this.setTitle("::. New Transfer Order - Processing Request.");
            thread.sleep(500);
            this.setTitle("::. New Transfer Order - Processing Request..");
    ...
    {
        String[] actName=systems.getTableDataArray(OpenMSApp.Database_A,"vwTransferAccount",2);
        actName[0]="-- Select --";
    ...
    public void resetDebitAccountName()
    {
        ...
        jDebitAccountNameComboBox.setModel(new DefaultComboBoxModel(actName));
    ...
    public void resetField()
    {
        ...
        jDebitAccountNameComboBox.setSelectedItem("-- Select --");
        jCreditAccountNameComboBox.setSelectedItem("-- Select --");
        resetDate();
    }
    private void disableControls()
    {
        ...
        jDebitAccountNameComboBox.setEnabled(false);
    ...
    private void enableControls()
    {
        ...
        jDebitAccountNameComboBox.setEnabled(true);
    ...
    private javax.swing.JComboBox jDebitAccountNameComboBox;

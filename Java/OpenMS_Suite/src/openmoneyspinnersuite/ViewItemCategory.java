...
final class ViewItemCategory extends javax.swing.JInternalFrame {
    ...
    public ViewItemCategory() {
        initComponents();
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            tableObject,
            new String [] {
                "Item Category Code", "Name"
            }
        ) {
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(openmoneyspinnersuite.OpenMS_Finance_App.class).getContext().getResourceMap(ViewItemCategory.class);
    ...
    private void jCancelButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCancelButtonActionPerformed
        ...
        if(processThread.isAlive())
        {
            ...
            this.setTitle("::. View Item Category");
            enableControls();
        }
        else
        dispose();
    ...
    {
        try{
            this.setTitle("::. View Item Category - Processing Request");
            thread.sleep(500);
            this.setTitle("::. View Item Category - Processing Request.");
            thread.sleep(500);
            this.setTitle("::. View Item Category - Processing Request..");
    ...
    {
        String[] itemCategoryCode=systems.getTableDataArrayNum(OpenMSApp.Database_A,"ItemCategory",1);
        String[] itemCategoryName=systems.getTableDataArrayNum(OpenMSApp.Database_A,"ItemCategory",2);

            if(searchPara.isEmpty()==false)
            {
                String multipleSearch[]=searchPara.split(",");
                String queryPara="where (cItemCategoryCode = '"+multipleSearch[0]+"') or (vCategoryName = '"+multipleSearch[0]+"') ";//or (cPhone like '%"+multipleSearch[0]+"%') ";

                for(int k=1;k<multipleSearch.length;k++)
                {
                    queryPara+="or (cItemCategoryCode like '%"+multipleSearch[k]+"%') or (vCategoryName like '%"+multipleSearch[k]+"%') ";//or (cPhone like '%"+multipleSearch[k]+"%') ";
                }

                itemCategoryCode=systems.getColumn(OpenMSApp.Database_A, "Select * from ItemCategory "+queryPara, 1);
                itemCategoryName=systems.getColumn(OpenMSApp.Database_A, "Select * from ItemCategory "+queryPara, 2);
            }

        int x=0;
        int y=itemCategoryCode.length;

        tableObject=new Object[y][2];

        while(x<y)
        {
            tableObject[x][0]=itemCategoryCode[x].trim();
            tableObject[x][1]=itemCategoryName[x].trim();
            systems.freeHeap();
            x+=1;
            if(x==y){break;}
       }

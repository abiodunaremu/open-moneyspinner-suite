...
final class NewInventoryReceivableDebit extends javax.swing.JInternalFrame {
    ...
    String debitOrderCode,creditOrderCode;
    Thread processThread=new Thread();
    Thread titleThread=new Thread();

    /** Creates new form NewCreditOrder */
    public NewInventoryReceivableDebit() {
        initComponents();
        setTitle("::. New Inventory Receivable Debit Order By User ("+OpenMSApp.EmployeeName+")");
        reset();
    ...
    private void initComponents() {
        ...
        jCreditAccountNameComboBox = new javax.swing.JComboBox();
        ...
        setMaximizable(true);
        setResizable(true);
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(openmoneyspinnersuite.OpenMS_Finance_App.class).getContext().getResourceMap(NewInventoryReceivableDebit.class);
        ...
        jCreditAccountNameComboBox.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "-- Select --", "Item 2", "Item 3", "Item 4" }));
        jCreditAccountNameComboBox.setName("jCreditAccountNameComboBox"); // NOI18N
        jCreditAccountNameComboBox.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jCreditAccountNameComboBoxActionPerformed(evt);
            }
        });
        ...
        jIRAccountNameComboBox.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "-- Select --" }));
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addComponent(jToBalanceTextField, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 267, Short.MAX_VALUE)
                            .addComponent(jAmtDueTextField, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 267, Short.MAX_VALUE)
                        ...
                        .addGap(4, 4, 4)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(jDebitActUnitTextField)
                            .addComponent(jCreditActUnitTextField)
                            .addComponent(jRefDepartmentComboBox, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addComponent(jCostOrderCodeComboBox, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addComponent(jCreditAccountNameComboBox, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addComponent(jIRAccountNameComboBox, javax.swing.GroupLayout.PREFERRED_SIZE, 185, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(36, 36, 36)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(95, 95, 95)
                        .addComponent(jDateTextField, javax.swing.GroupLayout.PREFERRED_SIZE, 267, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel1Layout.createSequentialGroup()
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(jCreditAccountNameComboBox, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(jLabel6))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    public void performMakeOrder(){
        ...
        for(int z=0;z<x;z++)
        {
            ...
            String dActName=jIRAccountNameComboBox.getSelectedItem().toString().trim();
            String cActName=jCreditAccountNameComboBox.getSelectedItem().toString().trim();
       ...
       int b=0;
        ...
        if(jCreditAccountNameComboBox.getSelectedItem().equals("-- Select --"))
        {
            JOptionPane.showMessageDialog(JOptionPane.getRootFrame(),"PLEASE SELECT CREDIT ACCOUNT ","ERROR !",JOptionPane.ERROR_MESSAGE);
            return;
        }
        if(jIRAccountNameComboBox.getSelectedItem().equals("-- Select --")==false||jCreditAccountNameComboBox.getSelectedItem().equals("-- Select --")==false)
        {
        ...
        String creditAccountName=String.valueOf(jCreditAccountNameComboBox.getSelectedItem());
        ...
        {
            JOptionPane.showMessageDialog(JOptionPane.getRootFrame()," SELECTED CREDIT ACCOUNT IS FROZEN ! \n SEE YOUR ACCOUNT ADMINISTRATOR FOR DETAILS.","ERROR !",JOptionPane.ERROR_MESSAGE);
            return;
        }
        String debitAccountName=String.valueOf(jIRAccountNameComboBox.getSelectedItem());
        ...
        {
                JOptionPane.showMessageDialog(JOptionPane.getRootFrame()," INSUFFICIENT FUND IN THE SELECTED INVENTROY RECEIVABLE ACCOUNT \n  FOR THIS TRANSACTION !","ERROR !",JOptionPane.ERROR_MESSAGE);
                return;
        }
        makeOrder();
        printReceipt();
    ...
    private void jCreditAccountNameComboBoxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCreditAccountNameComboBoxActionPerformed
        accountNameSelected();
    }//GEN-LAST:event_jCreditAccountNameComboBoxActionPerformed
    private void accountNameSelected()
    {
        String actName=jCreditAccountNameComboBox.getSelectedItem().toString().trim();
    ...
    private void jIRAccountNameComboBoxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jIRAccountNameComboBoxActionPerformed
        ...
        String dActName=jIRAccountNameComboBox.getSelectedItem().toString().trim();
        String cActName=jCreditAccountNameComboBox.getSelectedItem().toString().trim();
        if(dActName.equals("-- Select --"))
        {/* Execute submit thread */
            processThread=new Thread(new Runnable() {
                public void run() {
                disableControls();
                resetDebitAccountName();
                }
            });
            titleThread=new Thread(new Runnable() {
                public void run() {
        ...
        {
            jDebitActUnitTextField.setText(systems.getValue(OpenMSApp.Database_A, "Select * from Account Where vAccountName='"+dActName+"'","vAccountUnit" ));
        }
...
private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
    ...
    public void makeOrder()
    {
        ...
        String creditAccountName=String.valueOf(jCreditAccountNameComboBox.getSelectedItem()).trim();
        ...
        String debitAccountName=String.valueOf(jIRAccountNameComboBox.getSelectedItem()).trim();
        ...
        while(y<x)
        {
            if(!jTable1.getValueAt(y,3).equals("0"))
            {
             ...
             try{
                ...
                {
                        System.out.println("NewInventory ReceivableDebitOrder2.makeOrder() gave error ! "+e);
                }
            Connect.executeUpdateStatement(statement);
            }
            else
        ...
        statement=Connect.createStatement(Connect.procInit+"  prnInsDebitOrderOnOrder"+Connect.procInitStart+"?,?,?,?,?,?,?,?,?,?,?,?,?"+Connect.procInitEnd);
         try{
            ...
            {
                System.out.println("NewInventoryReceivableDebit3.makeOrder() gave error ! "+e);
            }
        Connect.executeUpdateStatement(statement);
        ...
        while(yi<xi)
        {
            if(!jTable1.getValueAt(yi,3).equals("0"))
            {
             ...
             try{
                ...
                {
                    System.out.println("NewInventoryReceivableDebitOrder4.makeOrder() gave error ! "+e);
                }
    ...
    public void selectUserDefault()
    {
        if(jCheckBox4.isSelected()==false)
        {
            ...
            jCreditAccountNameComboBox.setSelectedItem("STOCK RETAIL");
    ...
    {
        try{
            this.setTitle("::. New Inventory Receivable Debit Order - Processing Request");
            thread.sleep(500);
            this.setTitle("::. New Inventory Receivable Debit Order - Processing Request.");
            thread.sleep(500);
            this.setTitle("::. New Inventory Receivable Debit Order - Processing Request..");
    ...
    {
        String[] actName=systems.getTableDataArray(OpenMSApp.Database_A,"vwInventoryRevenueAccount",2);
        actName[0]="-- Select --";

        jCreditAccountNameComboBox.setModel(new DefaultComboBoxModel(actName));
    ...
    public void resetField()
    {
        ...
        jIRAccountNameComboBox.setSelectedItem("-- Select --");
        resetDate();
    }
    private void disableControls()
    {
        ...
        jCreditAccountNameComboBox.setEnabled(false);
    ...
    private void enableControls()
    {
        ...
        jCreditAccountNameComboBox.setEnabled(true);
    ...
    private javax.swing.JComboBox jCreditAccountNameComboBox;

...
final class PostCreditOrder extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(openmoneyspinnersuite.OpenMS_Finance_App.class).getContext().getResourceMap(PostCreditOrder.class);
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                ...
                                .addComponent(jNameTextField, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 384, Short.MAX_VALUE)
                                .addComponent(jTransactionUnitTextField, javax.swing.GroupLayout.PREFERRED_SIZE, 433, javax.swing.GroupLayout.PREFERRED_SIZE)))
                        .addGap(72, 72, 72))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addComponent(jCostOrderCodeTextField, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 245, Short.MAX_VALUE)
                            .addComponent(jAccountNameTextField, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 245, Short.MAX_VALUE)
                            .addComponent(jOrderDateTextField, javax.swing.GroupLayout.DEFAULT_SIZE, 245, Short.MAX_VALUE)
                            .addComponent(jConsentByTextField, javax.swing.GroupLayout.DEFAULT_SIZE, 245, Short.MAX_VALUE)
                            .addComponent(jRefDepartmentTextField, javax.swing.GroupLayout.DEFAULT_SIZE, 245, Short.MAX_VALUE)
                            .addComponent(jActivityTextField, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 245, Short.MAX_VALUE)))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(133, 133, 133)
    ...
    private void orderSelected()
    {
            ...
            String postState=systems.getValue(OpenMSApp.Database_A, "Select * from creditOrder where cCreditOrderCode='"+orderCode+"'", "cStatus");
           ...
           else
           {
                ...
                refreshTable();
                setTitle("::. Post Credit Order - Order By User ("+orderBy+")");
            }
    }
    private void setTitle()
    {
        if(jComboBox1.getSelectedItem().toString().equals("-- Select --"))
            super.setTitle("::. Post Credit Order");
        else
            super.setTitle("::. Post Credit Order - Order By User ("+orderBy+")");            
    }
...
private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
    ...
    private void postCurrentOrderCode()
    {
        ...
        String costOrderCode=systems.getValue(OpenMSApp.Database_A, "Select cCostOrderCode from Creditorder where cCreditOrderCode='"+String.valueOf(jComboBox1.getSelectedItem()).trim()+"'", "cCostOrderCode");
        ...
        {
            String totAmount=systems.getValue(OpenMSApp.Database_A, "Select mTotalAmount from Creditorder where cCreditOrderCode='"+String.valueOf(jComboBox1.getSelectedItem()).trim()+"'", "mTotalAmount");
        ...
        for(int x=0;x<credits.length;x++)
           systems.implementCosting(credits[x],"Credit");
        if(!debit.isEmpty())
    ...
    {
        try{
            this.setTitle("::. Post Credit Order - Processing Request");
            thread.sleep(500);
            this.setTitle("::. Post Credit Order - Processing Request.");
            thread.sleep(500);
            this.setTitle("::. Post Credit Order - Processing Request..");
    ...
    {
        String[] orderCode=systems.getTableDataArray(OpenMSApp.Database_A,"vwApprovedCreditOrder",1);
        orderCode[0]="-- Select --";
        jComboBox1.setModel(new DefaultComboBoxModel(orderCode));
        setTitle("::. Post Credit Order");
    }

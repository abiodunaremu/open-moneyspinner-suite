...
final class NewInvoice extends javax.swing.JInternalFrame {
    ...
    String addInUse="N";
    String delInUse="N";
    String invoiceOrderCode="";
    String activity="";
    String transType="";
    int counter=0;
    boolean freeingHeap=false;
    ...
    public NewInvoice() {
        initComponents();
        setTitle("::. New Invoice Order By User ("+OpenMSApp.EmployeeName+")");
        reset();
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(openmoneyspinnersuite.OpenMS_Finance_App.class).getContext().getResourceMap(NewInvoice.class);
        ...
        expiryYearComboBox.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "-- Year --" }));
        expiryYearComboBox.setName("expiryYearComboBox"); // NOI18N

        expiryDayComboBox.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "-- Day --" }));
        expiryDayComboBox.setName("expiryDayComboBox"); // NOI18N

        expiryMonthComboBox.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "-- Month --" }));
        expiryMonthComboBox.setName("expiryMonthComboBox"); // NOI18N
        expiryMonthComboBox.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                expiryMonthComboBoxActionPerformed(evt);
            }
        });
        ...
        jDiscountTextField.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                jDiscountTextFieldKeyPressed(evt);
            }
            public void keyReleased(java.awt.event.KeyEvent evt) {
                jDiscountTextFieldKeyReleased(evt);
            }
            public void keyTyped(java.awt.event.KeyEvent evt) {
                jDiscountTextFieldKeyTyped(evt);
            }
        });
        ...
        jNetAmountTextField.setEditable(false);
        jNetAmountTextField.setName("jNetAmountTextField"); // NOI18N
        jNetAmountTextField.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jNetAmountTextFieldActionPerformed(evt);
            }
        });
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                .addGroup(jPanel1Layout.createSequentialGroup()
                                    ...
                                    .addComponent(jAccountNameComboBox, javax.swing.GroupLayout.PREFERRED_SIZE, 239, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                                    ...
                                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        ...
                                        .addGroup(jPanel1Layout.createSequentialGroup()
                                            .addComponent(expiryMonthComboBox, javax.swing.GroupLayout.PREFERRED_SIZE, 80, javax.swing.GroupLayout.PREFERRED_SIZE)
                                            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                            .addComponent(expiryDayComboBox, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                                            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                        ...
                                        .addComponent(jDiscountTextField, javax.swing.GroupLayout.DEFAULT_SIZE, 240, Short.MAX_VALUE)
                                        .addComponent(jNetAmountTextField, javax.swing.GroupLayout.DEFAULT_SIZE, 240, Short.MAX_VALUE)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                    .addComponent(jNetAmountTextField, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    void performMakeOrder(){
       ...
       int b=0;
        ...
        if(!systems.isStringDecimal(jDiscountTextField.getText().trim()))
        {
            JOptionPane.showMessageDialog(JOptionPane.getRootFrame(),"DISCOUNT MUST BE IN MONEY FORMAT !","ERROR !",JOptionPane.ERROR_MESSAGE);
            //reset();
            return;
        }
        if(jAmountInWordsTextArea.getText().isEmpty())
        {
            JOptionPane.showMessageDialog(JOptionPane.getRootFrame(),"NET AMOUNT IN WORDS CAN NOT BE EMPTY !","ERROR !",JOptionPane.ERROR_MESSAGE);
            //reset();
            return;
        }
...
private void expiryMonthComboBoxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_expiryMonthComboBoxActionPerformed

        String expiryMonth=expiryMonthComboBox.getSelectedItem().toString();

        if(expiryMonth.equals("-- Month --")) {
        } else {
            resetExpiryDay(expiryMonth);
        }
}//GEN-LAST:event_expiryMonthComboBoxActionPerformed
...
private void jNetAmountTextFieldActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jNetAmountTextFieldActionPerformed
// TODO add your handling code here:
}//GEN-LAST:event_jNetAmountTextFieldActionPerformed

private void jDiscountTextFieldKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jDiscountTextFieldKeyPressed
calculateNetAmount();
}//GEN-LAST:event_jDiscountTextFieldKeyPressed

private void jDiscountTextFieldKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jDiscountTextFieldKeyReleased
calculateNetAmount();
}//GEN-LAST:event_jDiscountTextFieldKeyReleased

private void jDiscountTextFieldKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jDiscountTextFieldKeyTyped
calculateNetAmount();
}//GEN-LAST:event_jDiscountTextFieldKeyTyped
    
    synchronized void calculateNetAmount()
    {
        /*
        if(softSystems==null)
        {
        ...
        String discountValue=jDiscountTextField.getText();
        if(discountValue.isEmpty()){discountValue="0.0";}
        ...
        String netAmount=Systems.getInstance().getValue(OpenMSApp.Database_A, Connect.procInit+"  prnSubtractMoney"+Connect.procInitStart+""+totAmtValue+" , "+discountValue+Connect.procInitEnd, "mSumValue");
       try{
            jNetAmountTextField.setText(systems.converToRealMoneyFormat(netAmount)); 
       }
       catch(Exception e){
            jNetAmountTextField.setText("Er!M1C01K0");
       }
       discountValue=null;
       totAmtValue=null;
       netAmount=null;
...
//                        }
        ...
        try
        {
            String discount=jDiscountTextField.getText().isEmpty()?"0.0":jDiscountTextField.getText();
            
            jNetAmountTextField.setText(systems.converToRealMoneyFormat(systems.getValue(OpenMSApp.Database_A, Connect.procInit+"  prnSubtractMoney"+Connect.procInitStart+""+sumValue+" , "+(!systems.isStringDecimal(discount)?"0.0":discount)+Connect.procInitEnd, "mSumValue")));
    ...
    public void resetExpiryYear()
    {
        String[] year=systems.getYears(1920);
        year[0]="-- Year --";
        expiryYearComboBox.setModel(new DefaultComboBoxModel(year));
        year=null;
    }
    public void resetExpiryMonth()
    {
        String[] month=systems.getMonthArray();
        month[0]="-- Month --";

        expiryMonthComboBox.setModel(new DefaultComboBoxModel(month));
        month=null;
        
    }
    public void resetExpiryDay(String Month)
    {
        String[] day={"-- Day --"};
        if(Month.isEmpty())
        {
            expiryDayComboBox.setModel(new DefaultComboBoxModel(day));
        }
        else
        {
            day=systems.getDays(Month);
    ...
    {
        String expiryDate="";
        if(!(expiryYearComboBox.getSelectedItem().toString().equalsIgnoreCase("-- Year --")
            &&expiryMonthComboBox.getSelectedItem().toString().equalsIgnoreCase("-- Month --")
                &&expiryDayComboBox.getSelectedItem().toString().equalsIgnoreCase("-- Day --")))
            expiryDate=new String(String.valueOf(transYearComboBox.getSelectedItem()).trim()+"-"+systems.getMonthDigit(String.valueOf(transMonthComboBox.getSelectedItem()).trim())+"-"+
    ...
    public void makeOrder()
    {
        ...
        invoiceOrderCode=systems.getValue(OpenMSApp.Database_A, Connect.procInit+" prnPrintInvoiceOrderCode"+Connect.procInitStart+Connect.procInitEnd, "cCode");
       ...
       String departmentCode=systems.getValue(OpenMSApp.Database_A, "Select * from Department where vDepartmentName='"+departmentName+"'", "cDepartmentCode");
        ...
        System.out.println("InvoiceOrdercode= "+invoiceOrderCode);
        System.out.println("departmentcode= "+departmentCode);
        
        //Connect.createMSSQLConnection();
        Connect.changeDB(OpenMSApp.Database_A);
        statement=Connect.createStatement(Connect.procInit+"  prnInsInvoiceOrderOnOrder"+Connect.procInitStart+"?,?,?,?,?,?,?,?,?,?,?"+Connect.procInitEnd);
         try{
                ...
                statement.setString(7,systems.converToRealMoneyFormat(jTotAmountTextField.getText().trim()));
                statement.setString(8,departmentCode);
                statement.setString(9,getExpiryDate());
                statement.setString(10,jDiscountTextField.getText().isEmpty()?"0.0":jDiscountTextField.getText());
                statement.setString(11,jAmountInWordsTextArea.getText().trim());
            }
            catch(Exception e)
            {
        ...
        while(y<x)
        {
            if(!jTable1.getValueAt(y,3).equals("0"))
            {
                ...
                statement=Connect.createStatement(Connect.procInit+"  prnInsInvoiceOrderSummaryOnOrder"+Connect.procInitStart+"?,?,?,?,?"+Connect.procInitEnd);
                
             try{
                    statement.setString(1,invoiceOrderCode.trim());
    ...
    public void printInvoice()
    {
        if(jCheckBox5.isSelected())
        {
            ...
            for(JInternalFrame iFr:allIntFr)
            {
                ...
                {
                    ((POSPrint)iFr).setInvoiceValue(invoiceOrderCode);
                    found=true;
                }
            }
            if(found==false)
                this.getDesktopPane().add(new POSPrint(invoiceOrderCode));
            return;
        }
        try
        {
            NoteWriter note=new NoteWriter();
            note.writeInvoice(invoiceOrderCode,"",1);
                        
            if(OpenMSApp.d==null)
            {
                OpenMSApp.d=new NoteViewer("Preview Invoice - "+invoiceOrderCode,Configuration.officialReceiptURLPath);
            ...
            else if(OpenMSApp.d.isVisible()==false)
            {
                ...
                OpenMSApp.d.setTitle("Preview Inoice - "+invoiceOrderCode);
                OpenMSApp.d.doTas(1);
    ...
    {
        try{
            this.setTitle("::. New Invoice Order - Processing Request");
            thread.sleep(500);
            this.setTitle("::. New Invoice Order - Processing Request.");
            thread.sleep(500);
            this.setTitle("::. New Invoice Order - Processing Request..");
    ...
    public void resetField()
    {
        ...
        jNetAmountTextField.setText("0.0");
        jNameTextField.setText("");
    ...
    private javax.swing.JComboBox expiryDayComboBox;
    ...
    private javax.swing.JTextField jNetAmountTextField;

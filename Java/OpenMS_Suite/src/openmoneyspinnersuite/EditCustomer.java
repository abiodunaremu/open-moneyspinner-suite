...
final class EditCustomer extends javax.swing.JInternalFrame {
    PreparedStatement statement;
    ResultSet result;
    Systems systems=new Systems();
    Thread editCustomerThread=new Thread();
    Thread editCustomerTitleThread=new Thread();
    ...
    /** Creates new form Customer */
     EditCustomer() {
        ...
        editCustomerThread=new Thread(new Runnable() {
            public void run() {
                disableControls();
                resetCustomerID();
                resetCountry();
        ...
        editCustomerTitleThread=new Thread(new Runnable() {
            public void run() {
                while(editCustomerThread.isAlive())setProcessingTitle(editCustomerTitleThread);
                enableControls();
                System.out.println("accountThread stopped runing.");
            }
        });
        editCustomerThread.start();
        editCustomerTitleThread.start();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(openmoneyspinnersuite.OpenMS_Finance_App.class).getContext().getResourceMap(EditCustomer.class);
    ...
    private void jUpdateButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jUpdateButtonActionPerformed
        ...
        {
            JOptionPane.showMessageDialog(JOptionPane.getRootFrame(),"Please Select a Customer ID ","ERROR !",JOptionPane.ERROR_MESSAGE);
            return;
        }
    ...
    {
        try{
            this.setTitle("::. Edit Customer - Processing Request");
            thread.sleep(500);
            this.setTitle("::. Edit Customer - Processing Request.");
            thread.sleep(500);
            this.setTitle("::. Edit Customer - Processing Request..");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if(editCustomerThread.isAlive())
        {
            try{
                editCustomerThread.stop();
                editCustomerTitleThread.stop();
    ...
    private void customerIDSelected()
    {
        ...
        else
        {
            try
            {
                ...
                statement=Connect.createStatement("Select * from customer where cCustomerID= '"+customerID+"'");
            ...
            {
                System.out.println("Sql errror! at EditCustomer.customerIDComboBoxActionPerformed "+e);
            }
    ...
    {
        systems=new Systems();
        String[] customerID=systems.getTableDataArray(OpenMSApp.Database_A,"Customer",1);
        customerID[0]="-- Select --";
     ...
     void submitData()
    {
        //Connect.createMSSQLConnection();
        Connect.changeDB(OpenMSApp.Database_A);
        statement=Connect.createStatement(Connect.procInit+"  prnUpdCustomer"+Connect.procInitStart+"?,?,?,?,?,?,?,?"+Connect.procInitEnd);
            try{
            ...
            {
            System.out.println("EditCustomer.submitData() gave error ! "+e);
            }
        Connect.alert="Y";

 ...
 */
final public class OpenMS_FinanceAdmin_Desktop extends FrameView {
    ...
    Thread titleThread=new Thread();
     OpenMS_FinanceAdmin_Desktop(SingleFrameApplication app) {
        super(app);

        if(OpenMSApp.appType.equals("AX, Server, Trial"))
        {
            this.getFrame().setTitle("::. Account Administrator ["+systems.toTitleCase(OpenMSApp.EmployeeName)+" : "+OpenMSApp.CompanyName+"] - Milliscript MoneySpinner Suite "+OpenMSApp.appArchType+" 1.5.1 ["+OpenMSApp.trialDay+" Days Left]");
        }
        else if(OpenMSApp.appType.equals("Activated"))
        {
            this.getFrame().setTitle("::. Account Administrator ["+systems.toTitleCase(OpenMSApp.EmployeeName)+" : "+OpenMSApp.CompanyName+"] - Milliscript MoneySpinner Suite "+OpenMSApp.appArchType+" 1.5.1 ");
        }
        org.jdesktop.application.ResourceMap resourceMap0 = org.jdesktop.application.Application.getInstance(openmoneyspinnersuite.OpenMSApp.class).getContext().getResourceMap(OpenMS_FinanceAdmin_Desktop.class);
    ...
    private void initComponents() {
        ...
        NewMenu1 = new javax.swing.JMenu();
        nCreditMenuItem = new javax.swing.JMenuItem();
        nDebitMenuItem = new javax.swing.JMenuItem();
        nTransferMenuItem = new javax.swing.JMenuItem();
        nSolidLoanMenuItem = new javax.swing.JMenuItem();
        nSolidLoanDebitMenuItem = new javax.swing.JMenuItem();
        nIRCreditMenuItem = new javax.swing.JMenuItem();
        nIRDebitMenuItem = new javax.swing.JMenuItem();
        ...
        nStockCountMenuItem = new javax.swing.JMenuItem();
        ...
        vStockCountMenuItem = new javax.swing.JMenuItem();
        ...
        ConsentExpressMenu = new javax.swing.JMenu();
        ceCreditMenuItem = new javax.swing.JMenuItem();
        ceDebitMenuItem = new javax.swing.JMenuItem();
        ...
        jStockReportMenuItem = new javax.swing.JMenuItem();
        jCashMenu = new javax.swing.JMenu();
        jCashReportMenuItem = new javax.swing.JMenuItem();
        jReverseMenu = new javax.swing.JMenu();
        jReverseCreditMenuItem = new javax.swing.JMenuItem();
        jReverseDebitMenuItem = new javax.swing.JMenuItem();
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(openmoneyspinnersuite.OpenMS_Finance_App.class).getContext().getResourceMap(OpenMS_FinanceAdmin_Desktop.class);
        ...
        NewMenu1.setText(resourceMap.getString("NewMenu1.text")); // NOI18N
        NewMenu1.setName("NewMenu1"); // NOI18N
        NewMenu1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                NewMenu1ActionPerformed(evt);
            }
        });
        ...
        NewMenu1.add(nDebitMenuItem);

        nTransferMenuItem.setText(resourceMap.getString("nTransferMenuItem.text")); // NOI18N
        nTransferMenuItem.setName("nTransferMenuItem"); // NOI18N
        nTransferMenuItem.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                nTransferMenuItemActionPerformed(evt);
            }
        });
        NewMenu1.add(nTransferMenuItem);

        nSolidLoanMenuItem.setText(resourceMap.getString("nSolidLoanMenuItem.text")); // NOI18N
        nSolidLoanMenuItem.setName("nSolidLoanMenuItem"); // NOI18N
        nSolidLoanMenuItem.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                nSolidLoanMenuItemActionPerformed(evt);
            }
        });
        NewMenu1.add(nSolidLoanMenuItem);

        nSolidLoanDebitMenuItem.setText(resourceMap.getString("nSolidLoanDebitMenuItem.text")); // NOI18N
        nSolidLoanDebitMenuItem.setName("nSolidLoanDebitMenuItem"); // NOI18N
        nSolidLoanDebitMenuItem.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                nSolidLoanDebitMenuItemActionPerformed(evt);
            }
        });
        NewMenu1.add(nSolidLoanDebitMenuItem);

        nIRCreditMenuItem.setText(resourceMap.getString("nIRCreditMenuItem.text")); // NOI18N
        nIRCreditMenuItem.setName("nIRCreditMenuItem"); // NOI18N
        nIRCreditMenuItem.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                nIRCreditMenuItemActionPerformed(evt);
            }
        });
        NewMenu1.add(nIRCreditMenuItem);

        nIRDebitMenuItem.setText(resourceMap.getString("nIRDebitMenuItem.text")); // NOI18N
        nIRDebitMenuItem.setName("nIRDebitMenuItem"); // NOI18N
        nIRDebitMenuItem.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                nIRDebitMenuItemActionPerformed(evt);
            }
        });
        NewMenu1.add(nIRDebitMenuItem);
        ...
        NewMenu1.add(nInvoiceMenuItem);

        NewMenu.add(NewMenu1);
        ...
        nStockCountMenuItem.setText(resourceMap.getString("nStockCountMenuItem.text")); // NOI18N
        nStockCountMenuItem.setName("nStockCountMenuItem"); // NOI18N
        nStockCountMenuItem.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                nStockCountMenuItemActionPerformed(evt);
            }
        });
        NewMenu.add(nStockCountMenuItem);
        ...
        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(openmoneyspinnersuite.OpenMS_Finance_App.class).getContext().getActionMap(OpenMS_FinanceAdmin_Desktop.class, this);
        ...
        vStockCountMenuItem.setText(resourceMap.getString("vStockCountMenuItem.text")); // NOI18N
        vStockCountMenuItem.setName("vStockCountMenuItem"); // NOI18N
        vStockCountMenuItem.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                vStockCountMenuItemActionPerformed(evt);
            }
        });
        ViewMenu.add(vStockCountMenuItem);
        ...
        ConsentExpressMenu.setText(resourceMap.getString("ConsentExpressMenu.text")); // NOI18N
        ConsentExpressMenu.setName("ConsentExpressMenu"); // NOI18N

        ceCreditMenuItem.setText(resourceMap.getString("ceCreditMenuItem.text")); // NOI18N
        ceCreditMenuItem.setName("ceCreditMenuItem"); // NOI18N
        ceCreditMenuItem.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ceCreditMenuItemActionPerformed(evt);
            }
        });
        ConsentExpressMenu.add(ceCreditMenuItem);

        ceDebitMenuItem.setText(resourceMap.getString("ceDebitMenuItem.text")); // NOI18N
        ceDebitMenuItem.setName("ceDebitMenuItem"); // NOI18N
        ceDebitMenuItem.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ceDebitMenuItemActionPerformed(evt);
            }
        });
        ConsentExpressMenu.add(ceDebitMenuItem);

        ConsentMenu.add(ConsentExpressMenu);
        ...
        jStockReportMenuItem.setText(resourceMap.getString("jStockReportMenuItem.text")); // NOI18N
        jStockReportMenuItem.setName("jStockReportMenuItem"); // NOI18N
        jStockReportMenuItem.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jStockReportMenuItemActionPerformed(evt);
            }
        });
        jWindowMenu1.add(jStockReportMenuItem);

        menuBar.add(jWindowMenu1);

        jCashMenu.setText(resourceMap.getString("jCashMenu.text")); // NOI18N
        jCashMenu.setName("jCashMenu"); // NOI18N

        jCashReportMenuItem.setText(resourceMap.getString("jCashReportMenuItem.text")); // NOI18N
        jCashReportMenuItem.setName("jCashReportMenuItem"); // NOI18N
        jCashReportMenuItem.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jCashReportMenuItemActionPerformed(evt);
            }
        });
        jCashMenu.add(jCashReportMenuItem);

        menuBar.add(jCashMenu);

        jReverseMenu.setText(resourceMap.getString("jReverseMenu.text")); // NOI18N
        jReverseMenu.setName("jReverseMenu"); // NOI18N

        jReverseCreditMenuItem.setText(resourceMap.getString("jReverseCreditMenuItem.text")); // NOI18N
        jReverseCreditMenuItem.setName("jReverseCreditMenuItem"); // NOI18N
        jReverseCreditMenuItem.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jReverseCreditMenuItemActionPerformed(evt);
            }
        });
        jReverseMenu.add(jReverseCreditMenuItem);

        jReverseDebitMenuItem.setText(resourceMap.getString("jReverseDebitMenuItem.text")); // NOI18N
        jReverseDebitMenuItem.setName("jReverseDebitMenuItem"); // NOI18N
        jReverseDebitMenuItem.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jReverseDebitMenuItemActionPerformed(evt);
            }
        });
        jReverseMenu.add(jReverseDebitMenuItem);

        menuBar.add(jReverseMenu);
        ...
        MilliscriptMoneySpinnerToolBar.setPreferredSize(new java.awt.Dimension(473, 40));
        ...
        jSplitPane1.setPreferredSize(new java.awt.Dimension(261, 50));

        jToolBar1.setRollover(true);
        jToolBar1.setEnabled(false);
        jToolBar1.setName("jToolBar1"); // NOI18N

        jGlobalTextField.setText(resourceMap.getString("jGlobalTextField.text")); // NOI18N
        ...
        jSearchButton.setText(resourceMap.getString("jSearchButton.text")); // NOI18N
        ...
        systemDesktopPane.setMaximumSize(new java.awt.Dimension(20, 2147483647));
        ...
        jLabel2.setBounds(1071, 390, 110, 67);
    ...
    private void LogoutMenuItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_LogoutMenuItemActionPerformed
        ...
        if(access.equalsIgnoreCase("Out"))
        {
            ...
            javax.swing.JInternalFrame allInternalFrames[]=this.getDesktopPane().getAllFrames();
            for(int x=0;x<allInternalFrames.length;x++)
            {
                try{
                allInternalFrames[x].setClosed(true);
                allInternalFrames[x].dispose();
                allInternalFrames[x].removeAll();
                allInternalFrames[x]=null;
                }catch(Exception e){System.out.println("Error occured while closing internal frame "+e);}
            }
            allInternalFrames=null;
        ...
        else
        {
            ...
            for(int x=0;x<allInternalFrames.length;x++)
            {
                try{
                allInternalFrames[x].setClosed(true);
                allInternalFrames[x].setContentPane(null);
                allInternalFrames[x].dispose();
                allInternalFrames[x].removeAll();
                allInternalFrames[x]=null;
                }catch(Exception e){System.out.println("Error occured while closing internal frame "+e);}
        ...
        OpenMSApp.resetUserParameter();TRtread.stop();
        System.gc();
...
/* Execute submit thread */
        javax.swing.JInternalFrame allIntFrames[]=systemDesktopPane.getAllFrames();
        if(allIntFrames.length<2)
        {
            javax.swing.JInternalFrame nCreditOrder=new NewCreditOrder();
            systemDesktopPane.add(nCreditOrder);
            systemDesktopPane.moveToFront(nCreditOrder);
        ...
        else if(allIntFrames[0].getTitle().startsWith("::. New Credit Order"))
        {
            javax.swing.JInternalFrame nCreditOrder=new NewCreditOrder();
            systemDesktopPane.add(nCreditOrder);
            systemDesktopPane.moveToFront(nCreditOrder);
        ...
        {
            boolean found=false;
            for(javax.swing.JInternalFrame intFrame:allIntFrames)
                if(intFrame.getTitle().startsWith("::. New Credit Order"))
                {
        ...
        /*
            processThread=new Thread(new Runnable() {
                public void run() {
                    System.out.println("Finance plus new creditbuton started");
                    while(!nCreditOrder.isClosed())
                        try{
                            processThread.sleep(2000);
                        }
                        catch(Exception e){System.out.println("Thread ncreditorder error:"+e);}
                    nCreditOrder=null;
                }
            });
            processThread.start();
    ...
    private void jPrintMenuItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jPrintMenuItemActionPerformed
        ...
        if(frameTitle.equalsIgnoreCase("::. Preview POS Receipt"))
        {
            ((POSPrint)systemDesktopPane.getSelectedFrame()).print();
            return;
        }
     ...
     void resetComboControls()
    {
        ...
        {
            ((NewTransferOrder)systemDesktopPane.getSelectedFrame()).resetCombo();
        }
        if(frameTitle.startsWith("::. New Inventory Payable Credit Order"))
        {
            ((NewSolidLoanOrder)systemDesktopPane.getSelectedFrame()).resetCombo();
        }
        if(frameTitle.startsWith("::. New Inventory Payable Debit Order"))
        {
            ((NewSolidLoanDOrder)systemDesktopPane.getSelectedFrame()).resetCombo();
        }
        if(frameTitle.startsWith("::. New Inventory Receivable Credit Order"))
        {
            ((NewInventoryReceivableCredit)systemDesktopPane.getSelectedFrame()).resetCombo();
        }
        if(frameTitle.startsWith("::. New Inventory Receivable Debit Order"))
        {
            ((NewInventoryReceivableDebit)systemDesktopPane.getSelectedFrame()).resetCombo();
        }
        if(frameTitle.equalsIgnoreCase("::. View Merchant"))
        {
            ((ViewMerchant)systemDesktopPane.getSelectedFrame()).refreshTable("");
        }
    }
     ...
     void resetAllControls()
    {
        ...
        if(frameTitle.startsWith("::. Credit Consent"))
        {
        ...
        if(frameTitle.startsWith("::. Debit Consent"))
        {
        ...
        if(frameTitle.startsWith("::. New Transfer Order"))
        {
            ((NewTransferOrder)systemDesktopPane.getSelectedFrame()).reset();
        }
        if(frameTitle.startsWith("::. New Inventory Payable Credit Order"))
        {
            ((NewSolidLoanOrder)systemDesktopPane.getSelectedFrame()).reset();
        }
        if(frameTitle.startsWith("::. New Inventory Payable Debit Order"))
        {
            ((NewSolidLoanDOrder)systemDesktopPane.getSelectedFrame()).reset();
        }
        if(frameTitle.startsWith("::. View Stock History"))
        {
            ((InventoryHistory)systemDesktopPane.getSelectedFrame()).reset();
        }
        if(frameTitle.startsWith("::. View Stock Statistics"))
        {
            ((AuditInventory)systemDesktopPane.getSelectedFrame()).reset();
        }
        if(frameTitle.startsWith("::. New Inventory Receivable Credit Order"))
        {
            ((NewInventoryReceivableCredit)systemDesktopPane.getSelectedFrame()).reset();
        }
        if(frameTitle.startsWith("::. New Inventory Receivable Debit Order"))
        {
            ((NewInventoryReceivableDebit)systemDesktopPane.getSelectedFrame()).reset();
        }
     ...
     void refreshIfView()
    {
        ...
        if(frameTitle.equalsIgnoreCase("::. View Customer"))
        {
            ((ViewCustomer)systemDesktopPane.getSelectedFrame()).refreshTable("");
        }
        if(frameTitle.equalsIgnoreCase("::. View Account"))
        {
            ((ViewAccount)systemDesktopPane.getSelectedFrame()).refreshTable("");
        }
        if(frameTitle.equalsIgnoreCase("::. View Backup"))
        {
            ((ViewBackup)systemDesktopPane.getSelectedFrame()).refreshTable("");
        }
        if(frameTitle.equalsIgnoreCase("::. View Bank"))
        {
            ((ViewBank)systemDesktopPane.getSelectedFrame()).refreshTable("");
        }
        if(frameTitle.equalsIgnoreCase("::. View Department"))
        {
            ((ViewDepartment)systemDesktopPane.getSelectedFrame()).refreshTable("");
        }
        if(frameTitle.equalsIgnoreCase("::. View Batch"))
        {
            ((ViewBatch)systemDesktopPane.getSelectedFrame()).refreshTable("");
        }
        if(frameTitle.equalsIgnoreCase("::. View Designation"))
        {
            ((ViewDesignation)systemDesktopPane.getSelectedFrame()).refreshTable("");
        }
        if(frameTitle.equalsIgnoreCase("::. View Employee"))
        {
            ((ViewEmployee)systemDesktopPane.getSelectedFrame()).refreshTable("");
        }
        if(frameTitle.equalsIgnoreCase("::. View Designation"))
        {
            ((ViewDesignation)systemDesktopPane.getSelectedFrame()).refreshTable("");
        ...
        {
            ((ViewItem)systemDesktopPane.getSelectedFrame()).refreshTable("");
        }
        if(frameTitle.equalsIgnoreCase("::. View Item Category"))
        {
            ((ViewItemCategory)systemDesktopPane.getSelectedFrame()).refreshTable("");
        }
        if(frameTitle.equalsIgnoreCase("::. View Item Location"))
        {
            ((ViewItemLocation)systemDesktopPane.getSelectedFrame()).refreshTable("");
        }
        if(frameTitle.equalsIgnoreCase("::. View Stock Unit"))
        {
            ((ViewItemUnit)systemDesktopPane.getSelectedFrame()).refreshTable("");
        }
        if(frameTitle.equalsIgnoreCase("::. View System User"))
        {
            ((ViewLogin)systemDesktopPane.getSelectedFrame()).refreshTable("");
        }
        if(frameTitle.equalsIgnoreCase("::. View Merchant"))
        {
            ((ViewMerchant)systemDesktopPane.getSelectedFrame()).refreshTable("");
        ...
        if(frameTitle.equalsIgnoreCase("::. View System User Activity"))
        {
            ((ViewLoginRecord)systemDesktopPane.getSelectedFrame()).refreshTable("");
        }
        if(frameTitle.equalsIgnoreCase("::. View Transaction Type"))
        {
            ((ViewTransactionType)systemDesktopPane.getSelectedFrame()).refreshTable("");
        }
        if(frameTitle.equalsIgnoreCase("::. View Vendor"))
        {
            ((ViewVendor)systemDesktopPane.getSelectedFrame()).refreshTable("");
        }
        if(frameTitle.equalsIgnoreCase("::. View Stock Statistics"))
        {
            ((AuditInventory)systemDesktopPane.getSelectedFrame()).refreshTable("");
        }
        if(frameTitle.equalsIgnoreCase("::. View Currency"))
        {
            ((ViewCurrency)systemDesktopPane.getSelectedFrame()).refreshTable("");
        }
        if(frameTitle.equalsIgnoreCase("::. View Merchant"))
        {
            ((ViewMerchant)systemDesktopPane.getSelectedFrame()).refreshTable("");
    ...
    private void nTransferMenuItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_nTransferMenuItemActionPerformed
        // TODO add your handling code here:
        javax.swing.JInternalFrame nTransfer=new NewTransferOrder();
        systemDesktopPane.add(nTransfer);
        systemDesktopPane.moveToFront(nTransfer);

        try {
            nTransfer.setSelected(true);
        } catch(Exception e) {
            System.out.println("Error while adding new Transfer ! "+e);
        }
    }//GEN-LAST:event_nTransferMenuItemActionPerformed

    private void nSolidLoanMenuItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_nSolidLoanMenuItemActionPerformed
        // TODO add your handling code here:
        javax.swing.JInternalFrame nSolidLoan=new NewSolidLoanOrder();
        systemDesktopPane.add(nSolidLoan);
        systemDesktopPane.moveToFront(nSolidLoan);

        try {
            nSolidLoan.setSelected(true);
        } catch(Exception e) {
            System.out.println("Error while adding new inventory credit ! "+e);
        }
    }//GEN-LAST:event_nSolidLoanMenuItemActionPerformed

    private void nSolidLoanDebitMenuItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_nSolidLoanDebitMenuItemActionPerformed
        // TODO add your handling code here:
        javax.swing.JInternalFrame nSolidDLoan=new NewSolidLoanDOrder();
        systemDesktopPane.add(nSolidDLoan);
        systemDesktopPane.moveToFront(nSolidDLoan);

        try {
            nSolidDLoan.setSelected(true);
        } catch(Exception e) {
            System.out.println("Error while adding new inventory debit ! "+e);
        }
    }//GEN-LAST:event_nSolidLoanDebitMenuItemActionPerformed
    ...
    private void ceCreditMenuItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ceCreditMenuItemActionPerformed
        // TODO add your handling code here:
        javax.swing.JInternalFrame ceCreditOrder=new ConsentExpressCreditOrder();
        systemDesktopPane.add(ceCreditOrder);
        systemDesktopPane.moveToFront(ceCreditOrder);

        try {
            ceCreditOrder.setSelected(true);
        } catch(Exception e) {
            System.out.println("Error while adding consent express credit order ! "+e);
        }
    }//GEN-LAST:event_ceCreditMenuItemActionPerformed

    private void ceDebitMenuItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ceDebitMenuItemActionPerformed
        // TODO add your handling code here:
        javax.swing.JInternalFrame ceDebitOrder=new ConsentExpressDebitOrder();
        systemDesktopPane.add(ceDebitOrder);
        systemDesktopPane.moveToFront(ceDebitOrder);

        try {
            ceDebitOrder.setSelected(true);
        } catch(Exception e) {
            System.out.println("Error while adding consent express debit order ! "+e);
        }
    }//GEN-LAST:event_ceDebitMenuItemActionPerformed
    ...
    private void peCreditMenuItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_peCreditMenuItemActionPerformed
        ...
        try {
            ...
            System.out.println("Error while adding post express credit order ! "+e);
        }
     ...
     void search()
    {
        ...
        if(frameTitle.equalsIgnoreCase("::. View Stock Statistics"))
        {
            ((AuditInventory)systemDesktopPane.getSelectedFrame()).refreshTable(searchText);
        }
        if(frameTitle.equalsIgnoreCase("::. View Currency"))
        {
    ...
    private void jAddRowComboMenuItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jAddRowComboMenuItemActionPerformed
        ...
        if(frameTitle.startsWith("::. New Inventory Receivable Debit Order"))
        {
            ((NewInventoryReceivableDebit)systemDesktopPane.getSelectedFrame()).addRow();
        }
        if(frameTitle.startsWith("::. New Inventory Receivable Credit Order"))
        {
            ((NewInventoryReceivableCredit)systemDesktopPane.getSelectedFrame()).addRow();
        }
    ...
    private void jDeleteRowComboMenuItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jDeleteRowComboMenuItemActionPerformed
        ...
        if(frameTitle.startsWith("::. New Inventory Receivable Debit Order"))
        {
            ((NewInventoryReceivableDebit)systemDesktopPane.getSelectedFrame()).deleteRow();
        }
        if(frameTitle.startsWith("::. New Inventory Receivable Credit Order"))
        {
            ((NewInventoryReceivableCredit)systemDesktopPane.getSelectedFrame()).deleteRow();
        }
    ...
    private void NewMenu1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_NewMenu1ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_NewMenu1ActionPerformed

    private void nIRCreditMenuItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_nIRCreditMenuItemActionPerformed
        // TODO add your handling code here:
        javax.swing.JInternalFrame nIRCredit=new NewInventoryReceivableCredit();
        systemDesktopPane.add(nIRCredit);
        systemDesktopPane.moveToFront(nIRCredit);
        try
        {
            nIRCredit.setSelected(true);
        }
        catch(Exception e)
        {
            System.out.println("Error while adding new inventory receivable credit ! "+e);
        }
    }//GEN-LAST:event_nIRCreditMenuItemActionPerformed

    private void nIRDebitMenuItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_nIRDebitMenuItemActionPerformed
        // TODO add your handling code here:
        javax.swing.JInternalFrame nIRDebit=new NewInventoryReceivableDebit();
        systemDesktopPane.add(nIRDebit);
        systemDesktopPane.moveToFront(nIRDebit);
        try
        {
            nIRDebit.setSelected(true);
        }
        catch(Exception e)
        {
            System.out.println("Error while adding new inventory receivable debit ! "+e);
        }
    }//GEN-LAST:event_nIRDebitMenuItemActionPerformed
...
private void jStockReportMenuItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jStockReportMenuItemActionPerformed

        javax.swing.JInternalFrame vStockReport=new StockReport();
        systemDesktopPane.add(vStockReport);
        systemDesktopPane.moveToFront(vStockReport);

        try
        {
            vStockReport.setSelected(true);
        }
        catch(Exception e)
        {
            System.out.println("Error while adding stock report ! "+e);
        }
}//GEN-LAST:event_jStockReportMenuItemActionPerformed

private void nStockCountMenuItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_nStockCountMenuItemActionPerformed

        javax.swing.JInternalFrame nStockCount=new NewStockCount();
        systemDesktopPane.add(nStockCount);
        systemDesktopPane.moveToFront(nStockCount);

        try
        {
            nStockCount.setSelected(true);
        }
        catch(Exception e)
        {
            System.out.println("Error while adding new stock count ! "+e);
        }
}//GEN-LAST:event_nStockCountMenuItemActionPerformed

private void vStockCountMenuItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_vStockCountMenuItemActionPerformed

        javax.swing.JInternalFrame vStockCount=new ViewStockCount();
        systemDesktopPane.add(vStockCount);
        systemDesktopPane.moveToFront(vStockCount);

        try
        {
            vStockCount.setSelected(true);
        }
        catch(Exception e)
        {
            System.out.println("Error while adding view stock count ! "+e);
        }
}//GEN-LAST:event_vStockCountMenuItemActionPerformed

private void jCashReportMenuItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCashReportMenuItemActionPerformed

        javax.swing.JInternalFrame vCashReport=new CashReport();
        systemDesktopPane.add(vCashReport);
        systemDesktopPane.moveToFront(vCashReport);

        try
        {
            vCashReport.setSelected(true);
        }
        catch(Exception e)
        {
            System.out.println("Error while adding view cash report ! "+e);
        }
}//GEN-LAST:event_jCashReportMenuItemActionPerformed
...
private void jReverseCreditMenuItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jReverseCreditMenuItemActionPerformed

        javax.swing.JInternalFrame nReverseCredit=new ReverseCreditOrder();
        systemDesktopPane.add(nReverseCredit);
        systemDesktopPane.moveToFront(nReverseCredit);

        try
        {
            nReverseCredit.setSelected(true);
        }
        catch(Exception e)
        {
            System.out.println("Error while adding new reverse credit ! "+e);
        }
}//GEN-LAST:event_jReverseCreditMenuItemActionPerformed

private void jReverseDebitMenuItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jReverseDebitMenuItemActionPerformed

        javax.swing.JInternalFrame nReverseDebit=new ReverseDebitOrder();
        systemDesktopPane.add(nReverseDebit);
        systemDesktopPane.moveToFront(nReverseDebit);

        try
        {
            nReverseDebit.setSelected(true);
        }
        catch(Exception e)
        {
            System.out.println("Error while adding new reverse debit ! "+e);
        }
}//GEN-LAST:event_jReverseDebitMenuItemActionPerformed
...
private void nInvoiceMenuItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_nInvoiceMenuItemActionPerformed
    ...
    private javax.swing.JMenu ConsentExpressMenu;
    ...
    private javax.swing.JMenu NewMenu1;
    ...
    private javax.swing.JMenuItem ceCreditMenuItem;
    private javax.swing.JMenuItem ceDebitMenuItem;
    ...
    private javax.swing.JMenu jCashMenu;
    private javax.swing.JMenuItem jCashReportMenuItem;
    ...
    private javax.swing.JMenuItem jReverseCreditMenuItem;
    private javax.swing.JMenuItem jReverseDebitMenuItem;
    private javax.swing.JMenu jReverseMenu;
    ...
    private javax.swing.JMenuItem jStockReportMenuItem;
    ...
    private javax.swing.JMenuItem nIRCreditMenuItem;
    private javax.swing.JMenuItem nIRDebitMenuItem;
    ...
    private javax.swing.JMenuItem nSolidLoanDebitMenuItem;
    private javax.swing.JMenuItem nSolidLoanMenuItem;
    private javax.swing.JMenuItem nStockCountMenuItem;
    private javax.swing.JMenuItem nTransTypeMenuItem;
    private javax.swing.JMenuItem nTransferMenuItem;
    ...
    private javax.swing.JMenuItem vStockCountMenuItem;

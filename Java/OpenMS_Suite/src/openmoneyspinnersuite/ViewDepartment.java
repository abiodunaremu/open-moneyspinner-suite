...
final class ViewDepartment extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(openmoneyspinnersuite.OpenMS_Finance_App.class).getContext().getResourceMap(ViewDepartment.class);
    ...
    {
        try{
            this.setTitle("::. View Department - Processing Request");
            thread.sleep(500);
            this.setTitle("::. View Department - Processing Request.");
            thread.sleep(500);
            this.setTitle("::. View Department - Processing Request..");
    ...
    {
        String[] departmentCode=systems.getTableDataArrayNum(OpenMSApp.Database_A,"Department",1);
        String[] departmentName=systems.getTableDataArrayNum(OpenMSApp.Database_A,"Department",2);

            if(searchPara.isEmpty()==false)
            {
                String multipleSearch[]=searchPara.split(",");
                String queryPara="where (cDepartmentCode = '"+multipleSearch[0]+"') or (vDepartmentName = '"+multipleSearch[0]+"') ";// or (cPhone like '%"+multipleSearch[0]+"%') ";

                for(int k=1;k<multipleSearch.length;k++)
                {
                    queryPara+="or (cDepartmentCode like '%"+multipleSearch[k]+"%') or (vDepartmentName like '%"+multipleSearch[k]+"%') ";// or (cPhone like '%"+multipleSearch[k]+"%') ";
                }

                departmentCode=systems.getColumn(OpenMSApp.Database_A, "Select * from Department "+queryPara, 1);
                departmentName=systems.getColumn(OpenMSApp.Database_A, "Select * from Department "+queryPara, 2);
            }

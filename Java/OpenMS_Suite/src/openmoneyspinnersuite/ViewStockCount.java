...
final class ViewStockCount extends javax.swing.JInternalFrame {
    ...
    ViewStockCount() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            tableObject,
            new String [] {
                "Date","Item Code", "Item Name", "Counted By User", "Total Count", "Supply Shortfall"
            }
        ) {
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(openmoneyspinnersuite.OpenMS_Finance_App.class).getContext().getResourceMap(ViewStockCount.class);
    ...
    private void jCancelButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCancelButtonActionPerformed
        ...
        if(processThread.isAlive())
        {
            ...
            this.setTitle("::. View Stock Count");
            enableControls();
        }
        else
        dispose();
...
private void transMonthComboBoxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_transMonthComboBoxActionPerformed
    ...
    {
        try{
            this.setTitle("::. View Stock Count - Processing Request");
            thread.sleep(500);
            this.setTitle("::. View Stock Count - Processing Request.");
            thread.sleep(500);
            this.setTitle("::. View Stock Count - Processing Request..");
    ...
    void refreshTable(String searchPara)
    {
        ...
        String[][] stockCount=systems.getTableDataArrayNum(OpenMSApp.Database_A,"StockCount "+dateQuery+" order by dDate",1,2,3,4,5);
            if(searchPara.isEmpty()==false)
            {
                ...
                stockCount=systems.getColumn(OpenMSApp.Database_A, "Select * from StockCount "+queryPara+" order by dDate", 1,2,3,4,5);
            }

        int x=0;
        int y=stockCount[0].length;

        tableObject=new Object[y][6];

        while(x<y)
        {
            tableObject[x][0]=stockCount[3][x].trim();
            tableObject[x][1]=stockCount[0][x].trim();
            tableObject[x][2]=systems.getValue(OpenMSApp.Database_A, "Select * from item where cItemCode='"+stockCount[0][x].trim()+"'", 2);
            tableObject[x][3]=stockCount[1][x].trim();
            tableObject[x][4]=stockCount[2][x].trim();
            tableObject[x][5]=stockCount[4][x].trim();
            systems.freeHeap();
            x+=1;
            if(x==y){break;}
       }
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            tableObject,
            new String [] {
                "Date","Item Code", "Item Name", "Counted By User", "Quantity", "Supply Shortfall"
            }
        ) {
            boolean[] canEdit = new boolean [] {
                false, false, false, false, false, false

...
final class Vendor extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setResizable(true);
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(openmoneyspinnersuite.OpenMS_Finance_App.class).getContext().getResourceMap(Vendor.class);
    ...
    void submitData()
    {
        ...
        statement=Connect.createStatement(Connect.procInit+"  prnInsVendor"+Connect.procInitStart+"?,?,?,?,?,?,?,?"+Connect.procInitEnd);
            try{
            ...
            {
            System.out.println("Vendor.submitData() gave error ! "+e);
            }
        Connect.alert="Y";
